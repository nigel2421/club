        ...
        <form action="{{ route('members.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="doj" id="doj" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('doj') }}">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="race" id="race" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('race') }}">
                </div>
                <div class="mb-4">
                    <label for="minimum_spent" class="block text-gray-700 text-sm font-bold mb-2">Minimum Spent:</label>
                    <input type="number" name="minimum_spent" id="minimum_spent" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('minimum_spent') }}">
                </div>
                <div class="mb-4">
                    <label for="contact_details" class="block text-gray-700 text-sm font-bold mb-2">Contact Details:</label>
                    <input type="text" name="contact_details" id="contact_details" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('contact_details') }}" required>
                </div>
                <div class="mb-4">
                    <label for="status" class="block text-gray-700 text-sm font-bold mb-2">Status:</label>
                    <select name="status" id="status" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                        <option value="good_standing" {{ old('status') == 'good_standing' ? 'selected' : '' }}>Good Standing</option>
                        <option value="delinquent" {{ old('status') == 'delinquent' ? 'selected' : '' }}>Delinquent</option>
                    </select>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="date_of_birth" id="date_of_birth" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('date_of_birth') }}" required>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div id="subscriptions-container">
                    @if(old('subscriptions'))
                        @foreach(old('subscriptions') as $index => $subscription)
                    ...
                    @else
                        <div class="grid grid-cols-2 gap-4 mb-2">
                            <div>
                                <label class="block text-gray-700 text-sm font-bold mb-2">Year:</label>
                                <input type="number" name="subscriptions[0][year]" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                            </div>
                            <div>
                                <label class="block text-gray-700 text-sm font-bold mb-2">Revenue:</label>
                                <input type="number" name="subscriptions[0][revenue]" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" step="0.01">
                            </div>
                        </div>
                    @endif
                </div>
